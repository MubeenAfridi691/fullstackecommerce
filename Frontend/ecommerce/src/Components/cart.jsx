...
const cart = () => {
    ...
    const fetchData = async() =>{
        ...
        const response = await fetch(simmaryapi.addtocartproduct.url,{
    ...
    const decraseQty = async(id,qty) =>{
       if(qty >= 2){
            const response = await fetch(simmaryapi.updateaddtocartproduct.url,{
                method : simmaryapi.updateaddtocartproduct.method,
                credentials : 'include',
                headers : {
                    "content-type" : 'application/json'
                },
    ...
    const deleteCartProduct = async(id)=>{
        const response = await fetch(simmaryapi.deleteaddtoCartProduct.url,{
            method : simmaryapi.deleteaddtoCartProduct.method,
            credentials : 'include',
            headers : {
                "content-type" : 'application/json'
            },
